...
# substitutes the reported hashes in place).
{
  ...
  llvm-mos = {
    ...
    hash = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="; # PREFETCH:llvm-mos-source
  };
  ...
  llvm-mos-sdk = {
    ...
    hash = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="; # PREFETCH:llvm-mos-sdk-source
  };
  ...
  rust-mos-src-hash = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="; # PREFETCH:rust-mos-src
  check-vendor-hash = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="; # PREFETCH:check-vendor
